...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default PowSeqResults pow(PowSeq inputSeq)
    {
        return pow(inputSeq, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default PowSeqResults pow(PowSeq inputSeq, java.util.Map<String, String> context)
    {
        return _iceI_powAsync(inputSeq, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<PowSeqResults> powAsync(PowSeq inputSeq)
    {
        return _iceI_powAsync(inputSeq, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<PowSeqResults> powAsync(PowSeq inputSeq, java.util.Map<String, String> context)
    {
        return _iceI_powAsync(inputSeq, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<PowSeqResults> _iceI_powAsync(PowSeq iceP_inputSeq, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<PowSeqResults> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "pow", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     PowSeq.ice_write(ostr, iceP_inputSeq);
                 }, istr -> {
                     PowSeqResults ret;
                     ret = PowSeqResults.ice_read(istr);
                     return ret;
                 });
        return f;
    }

    default double avg(PowSeqResults input)
    {
        return avg(input, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double avg(PowSeqResults input, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(input, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(PowSeqResults input)
    {
        return _iceI_avgAsync(input, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(PowSeqResults input, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(input, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_avgAsync(PowSeqResults iceP_input, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "avg", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     PowSeqResults.ice_write(ostr, iceP_input);
                 }, istr -> {
                     double ret;
                     ret = istr.readDouble();
                     return ret;
