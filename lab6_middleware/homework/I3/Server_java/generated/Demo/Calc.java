...
public interface Calc extends com.zeroc.Ice.Object
{
    ...
    PowSeqResults pow(PowSeq inputSeq, com.zeroc.Ice.Current current);

    double avg(PowSeqResults input, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_pow(Calc obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        PowSeq iceP_inputSeq;
        iceP_inputSeq = PowSeq.ice_read(istr);
        inS.endReadParams();
        PowSeqResults ret = obj.pow(iceP_inputSeq, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        PowSeqResults.ice_write(ostr, ret);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_avg(Calc obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        PowSeqResults iceP_input;
        iceP_input = PowSeqResults.ice_read(istr);
        inS.endReadParams();
        double ret = obj.avg(iceP_input, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 7:
            {
                return _iceD_pow(this, in, current);
            }
            case 8:
            {
